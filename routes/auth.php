...
Route::middleware('guest')->group(function () {
    ...
    Route::post('verify-access', [TwoFactorController::class, 'verify'])->name('otp.verify');
    Route::get('verify-access/status', [TwoFactorController::class, 'checkStatus'])->name('otp.status');
    Route::get('verify-access/{token}', [TwoFactorController::class, 'handshake'])->name('otp.handshake');
