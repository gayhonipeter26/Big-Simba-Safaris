...
const showAvatar = computed(() => !!userAvatar.value && userAvatar.value !== '');
const userName = computed(() => props.user?.name || 'Guest Traveler');
const userEmail = computed(() => props.user?.email || 'guest@example.com');
</script>
