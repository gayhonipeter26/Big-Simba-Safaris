        ...
        <div v-if="!showNativeForm" class="flex flex-col gap-4">
            ...
            <a :href="route('google.redirect')" class="w-full">
                <Button variant="outline" class="h-12 w-full flex items-center justify-center gap-3 border-white/10 hover:bg-white/5 transition-all rounded-full group">
                    ...
                    <span class="text-[10px] font-black uppercase tracking-[0.2em] group-hover:text-safari-gold transition-colors">Continue with Google</span>
                </Button>
            </a>
            ...
            <Button variant="outline" class="h-12 w-full flex items-center gap-3 border-white/10 hover:bg-white/5 transition-all rounded-full group">
                ...
                <span class="text-[10px] font-black uppercase tracking-[0.2em] group-hover:text-safari-gold transition-colors">Continue with Apple</span>
            </Button>
            ...
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    <div class="flex items-center justify-between">
                        ...
                        <TextLink v-if="canResetPassword" :href="route('password.request')" class="text-[10px] font-black uppercase tracking-widest opacity-40 hover:opacity-100 transition-all"> Forgot? </TextLink>
                    </div>
                ...
                <Button type="submit" class="mt-4 w-full bg-safari-gold hover:bg-white text-black text-[10px] font-black uppercase tracking-[0.2em]" tabindex="4" :disabled="form.processing">
