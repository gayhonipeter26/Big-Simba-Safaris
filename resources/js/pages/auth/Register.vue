        ...
        <form v-else @submit.prevent="submit" class="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    <Label for="name" class="text-sm font-black uppercase tracking-widest opacity-90">Full Name</Label>
                ...
                <div class="grid gap-2">
                    <Label for="password_confirmation" class="text-sm font-black uppercase tracking-widest opacity-90">Confirm Password</Label>
                ...
                <Button type="submit" class="mt-4 w-full bg-safari-gold hover:bg-white text-black text-sm font-black uppercase tracking-[0.2em]" tabindex="5" :disabled="form.processing">
