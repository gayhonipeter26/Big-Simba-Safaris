    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 md:p-10 space-y-10 max-w-[1400px] mx-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-white/5 pb-10">
                 <div>
                      <h1 class="font-display text-3xl font-black uppercase tracking-tighter mb-2 text-safari-gold">Refine Safari Story</h1>
                      <p class="text-xs opacity-90 uppercase tracking-widest italic">Maintain the narrative soul of Big Simba</p>
                 </div>
                 <button @click="submit" :disabled="form.processing" class="px-8 py-4 bg-safari-gold text-black text-sm font-black uppercase tracking-widest hover:bg-white transition-all rounded-sm flex items-center gap-2 shadow-[0_0_30px_rgba(202,138,4,0.3)]">
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 xl:grid-cols-3 gap-10">
                ...
                <div class="xl:col-span-2 space-y-10">
                    <div class="bg-card border border-white/5 rounded-sm p-10 space-y-8 shadow-2xl">
                        <div class="flex items-center gap-4 text-safari-gold mb-4">
                             <Info class="w-4 h-4" />
                             <h2 class="font-display text-xs font-black uppercase tracking-[0.4em]">Section Narratives</h2>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                             <div class="space-y-4">
                                  <label class="text-sm font-black uppercase tracking-[0.3em] opacity-80">Main Headline</label>
                             ...
                             <div class="space-y-4">
                                  <label class="text-sm font-black uppercase tracking-[0.3em] opacity-80">Subheader Registry</label>
                        ...
                        <div class="space-y-4">
                             <label class="text-sm font-black uppercase tracking-[0.3em] opacity-80">Mission Briefing (About Content)</label>
                    ...
                    <div class="bg-card border border-white/5 rounded-sm p-10 space-y-8 shadow-2xl">
                        <div class="flex items-center gap-4 text-safari-gold mb-4">
                             ...
                             <h2 class="font-display text-xs font-black uppercase tracking-[0.4em]">Visual Intelligence</h2>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                             <div class="space-y-4">
                                  <label class="text-sm font-black uppercase tracking-[0.3em] opacity-80">Primary Showcase Image</label>
                             ...
                             <div class="space-y-4">
                                  <label class="text-sm font-black uppercase tracking-[0.3em] opacity-80">Tactical Offset Image</label>
                ...
                <div class="space-y-10">
                    <div class="bg-card border border-white/5 rounded-sm p-10 space-y-8 shadow-2xl">
                        <div class="flex items-center gap-4 text-safari-gold mb-4">
                             <Award class="w-4 h-4" />
                             <h2 class="font-display text-xs font-black uppercase tracking-[0.4em]">Strength Metrics</h2>
                        </div>

                        <div class="space-y-6">
                            <div class="space-y-3">
                                 <label class="text-sm font-black uppercase tracking-[0.3em] opacity-80">Years of Dominance</label>
                            ...
                            <div class="space-y-3">
                                 <label class="text-sm font-black uppercase tracking-[0.3em] opacity-80">Tours Dispatched</label>
                    ...
                    <div class="bg-card border border-white/5 rounded-sm p-10 space-y-8 shadow-2xl">
                        <div class="flex items-center gap-4 text-safari-gold mb-4">
                             ...
                             <h2 class="font-display text-xs font-black uppercase tracking-[0.4em]">Pulse Status</h2>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                             ...
                             <label for="active" class="text-sm font-black uppercase tracking-[0.3em] cursor-pointer">Deploy Narratives Live</label>
                        </div>

                        <p class="text-xs opacity-20 uppercase tracking-[0.2em] italic leading-loose">
