        ...
        <div class="p-6 md:p-10 space-y-12 max-w-screen-xl mx-auto pb-44">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-white/5 pb-10">
                 <div class="flex items-center gap-6">
                      ...
                      <div>
                           <h1 class="text-3xl font-black uppercase tracking-tighter mb-2">Edit Chronicle</h1>
                           <p class="text-xs opacity-50 uppercase tracking-widest">Update the saga for the pride</p>
                      </div>
                 </div>
                 <div class="flex items-center gap-6">
                      <div class="flex items-center gap-2 pr-6 border-r border-white/5">
                           ...
                           <label class="text-[10px] font-bold uppercase tracking-widest opacity-40">Published</label>
                      </div>
                 ...
                 <div class="lg:col-span-2 space-y-10">
                      <div class="bg-card border border-white/5 p-10 rounded-sm space-y-10">
                           ...
                           <div class="space-y-4">
                                ...
                                <textarea v-model="form.content" rows="15" class="bg-white/5 border border-white/10 rounded-sm px-6 py-4 outline-none focus:border-safari-gold transition-all text-sm opacity-60 leading-relaxed w-full font-light"></textarea>
                 ...
                 <div class="lg:col-span-1 space-y-10">
                      <div class="bg-card border border-white/5 p-8 rounded-sm space-y-6">
                           ...
                           <div class="space-y-4 mt-6">
                                ...
                                <input v-model="form.image" type="text" class="bg-white/5 border border-white/10 rounded-sm px-6 py-3 outline-none focus:border-safari-gold transition-all text-[10px] w-full" />
