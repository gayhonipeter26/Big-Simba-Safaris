        ...
        <div class="p-6 md:p-10 space-y-12 max-w-screen-xl mx-auto pb-44">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-white/5 pb-10">
                 <div class="flex items-center gap-6">
                      ...
                      <div>
                           <h1 class="text-3xl font-black uppercase tracking-tighter mb-2">New Chronicle</h1>
                           <p class="text-xs opacity-50 uppercase tracking-widest">Scribe another chapter in the Simba saga</p>
                      </div>
                 </div>
                 <div class="flex items-center gap-6">
                      <div class="flex items-center gap-2 pr-6 border-r border-white/5">
                           ...
                           <label class="text-[10px] font-bold uppercase tracking-widest opacity-40">Publish Now</label>
                      </div>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                 <div class="lg:col-span-2 space-y-10">
                      <div class="bg-card border border-white/5 p-10 rounded-sm space-y-10">
                           <div class="space-y-4">
                                <label class="text-[10px] font-bold uppercase tracking-widest opacity-40">Story Title</label>
                           ...
                           <div class="space-y-4">
                                <label class="text-[10px] font-bold uppercase tracking-widest opacity-40">Permanent URL (Slug)</label>
                                <input v-model="form.slug" type="text" class="bg-white/5 border border-white/10 rounded-sm px-6 py-3 outline-none focus:border-safari-gold transition-all text-xs opacity-60 w-full" />
                                <p v-if="form.errors.slug" class="text-xs text-red-500">{{ form.errors.slug }}</p>
                           </div>

                           <div class="space-y-4">
                                <label class="text-[10px] font-bold uppercase tracking-widest opacity-40">Chronicle Data (Content)</label>
                                <textarea v-model="form.content" rows="15" class="bg-white/5 border border-white/10 rounded-sm px-6 py-4 outline-none focus:border-safari-gold transition-all text-sm opacity-60 leading-relaxed w-full font-light" placeholder="Once upon a savanna..."></textarea>
                 ...
                 <div class="lg:col-span-1 space-y-10">
                      <div class="bg-card border border-white/5 p-8 rounded-sm space-y-6">
                           <h3 class="text-[10px] font-black uppercase tracking-widest opacity-40 mb-6">Gallery Piece</h3>
                           <div class="aspect-square bg-white/5 border border-white/5 rounded-sm overflow-hidden flex items-center justify-center group relative">
                                ...
                                <div class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center p-6 text-center">
                                     <p class="text-[8px] font-black uppercase tracking-widest">Update URL Below</p>
                                </div>
                           </div>
                           <div class="space-y-4 mt-6">
                                <label class="text-[9px] font-bold uppercase tracking-widest opacity-40">Cover Image URL</label>
                                <input v-model="form.image" type="text" class="bg-white/5 border border-white/10 rounded-sm px-6 py-3 outline-none focus:border-safari-gold transition-all text-[10px] w-full" placeholder="Unsplash/Media Link" />
                      ...
                      <div class="p-8 bg-safari-gold/5 border border-safari-gold/20 rounded-sm">
                           <h4 class="text-[9px] font-black uppercase tracking-widest mb-4">Scribe Tip</h4>
                           <p class="text-[10px] opacity-40 leading-relaxed font-light italic">"Stories with high-quality cover images receive 3x more engagement from the pride."</p>
                      </div>
                 </div>
            </form>
        </div>
