        ...
        <div class="p-6 md:p-10 space-y-12 max-w-7xl mx-auto pb-44">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-white/5 pb-10">
                 <div class="flex items-center gap-6">
                      ...
                      <div>
                           <h1 class="text-3xl font-black uppercase tracking-tighter mb-2">Edit Expedition</h1>
                           <p class="text-xs opacity-50 uppercase tracking-widest">Update the {{ tour.name }} details</p>
                      </div>
                 </div>
